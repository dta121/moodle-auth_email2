...
class login_signup_form extends moodleform implements renderable, templatable {
    function definition() {
        ...
        $mform->addElement('html','<hr><p><i class="fa fa-info-circle" aria-hidden="true"></i> To avoid any unnecessary name chances on the certificate, enter the first and last name you like to appear on the certificate.</p><p>For example, if you\'re first name is <b>Jonathan</b> and you\'re last name is <b>Smith</b>, but you go by <b>Jon Smith</b>, and you want that to appear on your certificate, please enter <b>Jon</b> in the First name field.</p>');
